...
class TestUnrealModel(tf.test.TestCase):
    def test_unreal_variable_size(self):
        ...
        # rp:   fc=2
        self.check_model_var_size(use_pixel_change, use_value_replay,
                                  use_reward_prediction, 20)
